...
export default function Dashboard() {
  const { userId, role, signOut } = useMockAuth()
  ...
  useEffect(() => {
    ...
    // Capture non-null references for inner closures
            ...
            <Card className="bg-slate-900/50 border-slate-700/50 backdrop-blur-sm h-full">
              <CardContent className="p-4">
                <nav className="space-y-2">
                  ...
                  <NavItem icon={Globe} label="Community" href="/dashboard/admin/community/feed" />
                  <NavItem icon={MessageSquare} label="Chat" href="/dashboard/admin/community/messages" />
                  <NavItem icon={Database} label="Classes" />
                  <NavItem icon={Globe} label="Activities" />
                  <NavItem icon={Shield} label="Assignments" />
                  <NavItem icon={Terminal} label="Grades" />
                ...
                <div className="mt-8 pt-6 border-t border-slate-700/50">
                  <div className="text-xs text-slate-500 mb-2 font-mono">LEARNING STATUS</div>
                  <div className="space-y-3">
                    <StatusItem label="Classes" value={systemStatus} color="cyan" />
                    <StatusItem label="Assignments" value={securityLevel} color="green" />
                    <StatusItem label="Progress" value={networkStatus} color="blue" />
                  </div>
                </div>
              </CardContent>
            </Card>
                      ...
                      <TabsContent value="performance" className="mt-0">
                        <div className="h-64 w-full relative bg-slate-800/30 rounded-lg border border-slate-700/50 overflow-hidden">
                          ...
                          <div className="absolute bottom-4 right-4 bg-slate-900/80 backdrop-blur-sm rounded-md px-3 py-2 border border-slate-700/50">
                            <div className="text-xs text-slate-400">Course Load</div>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Badge className="bg-green-500/20 text-green-400 border-green-500/50">On Track</Badge>
                      </div>
                      <div className="flex items-center justify-between">
                        <div className="text-sm text-slate-400">Grades</div>
                        <Badge className="bg-green-500/20 text-green-400 border-green-500/50">Improving</Badge>
                      </div>
                      <div className="flex items-center justify-between">
                        <div className="text-sm text-slate-400">Last Sync</div>
                        <div className="text-sm text-cyan-400">Updated <span className="text-slate-500">12 min ago</span></div>
                      </div>
